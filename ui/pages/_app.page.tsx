...
// Status
  ...
  return (
	<div className={styles.container}>	
	  <Head>
        <title>zkApp [Ookim]</title>
        <meta name="description" content="ZkApp By Ookim" />
		...
		<main className={styles.main}>
			...
			<div id="footer" style={{display: 'block'}} >	
				...
				<a style={{display: 'block'}} href="https://t.me/perozpeko" target="_blank" rel="noopener noreferrer" >
						<span className={styles.teleIcon}> </span>
					</a>
					
				<a style={{display: 'block'}} href="https://discordapp.com/users/470588392229437440" target="_blank" rel="noopener noreferrer" >
						<span className={styles.dcIcon}> </span>
					</a>
					
				<a style={{display: 'block'}} href="https://github.com/gayusdjatmiko" target="_blank" rel="noopener noreferrer" >
						<span className={styles.gitIcon}> </span>
					</a>
					
				<a style={{display: 'block'}} href="https://twitter.com/Ookim_" target="_blank" rel="noopener noreferrer" >
